...
module tpns_class
    ...
    type :: tpns
       ...
       integer, dimension(:,:,:), allocatable :: Upwindmask                     !< Integer array used for modifying W metrics
 ...
 contains
    ...
    subroutine initialize(this,cfg,name)
       ...
       allocate(this%Upwindmask(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Upwindmask=0
