      ...
      do k=this%cfg%kmin_,this%cfg%kmax_
         do j=this%cfg%jmin_,this%cfg%jmax_
            do i=this%cfg%imin_,this%cfg%imax_
               ...
               if ((this%norm_pos(i,j,k)-this%norm_neg(i,j,k)).ge.0.5_WP.or.(((this%norm_pos(i,j,k)-this%norm_neg(i,j,k)).lt.0.5_WP).and.(this%norm_pos(i,j,k)+this%norm_neg(i,j,k).lt.0.5_WP))) then
