...
module tpns_class
   ...
   contains
      ...
      procedure :: update_laplacian_slip                       !< Update the pressure Laplacian div(1/rho*grad(.))
      procedure :: get_div_slip                                !< Calculate velocity divergence
      procedure :: get_pgrad_slip                              !< Calculate pressure gradient
   end type tpns
