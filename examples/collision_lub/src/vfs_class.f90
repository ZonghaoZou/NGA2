...
module vfs_class
   ...
   type :: vfs
      ...
      real(WP), dimension(:,:,:), allocatable :: thickness_old       !< Local thickness of thin region
...
contains
   ...
   subroutine initialize(this,cfg,reconstruction_method,transport_method,name)
      ...
      case (r2p,r2pnet)
         ...
         allocate(this%thickness_old(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%thickness_old=0.0_WP
   ...
   subroutine build_r2pnet(this)
      ...
      do k=this%cfg%kmin_,this%cfg%kmax_; do j=this%cfg%jmin_,this%cfg%jmax_; do i=this%cfg%imin_,this%cfg%imax_
         ...
         if ((this%norm_pos(i,j,k)-this%norm_neg(i,j,k)).ge.0.5_WP.or.(((this%norm_pos(i,j,k)-this%norm_neg(i,j,k)).lt.0.5_WP).and.(this%norm_pos(i,j,k)+this%norm_neg(i,j,k).lt.0.85_WP))) then
            ! PLICNET
            ! Liquid-gas symmetry
