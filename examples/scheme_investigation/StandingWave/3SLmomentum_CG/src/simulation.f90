...
module simulation
   ...
   !> Problem definition
   real(WP) :: A0,lambda,dx
   real(WP) :: Ameasure,Ameasure_
...
contains
   ...
   subroutine simulation_init
      ...
      create_and_initialize_vof: block
         ...
         dx = twoPi/(1.0_WP*nx)
         lambda=twoPi
         call param_read('A0',A0); A0=A0*lambda
      ...
      create_monitor: block
         ...
         call mfile%add_column(Ameasure,'A0')
   ...
   contains
      ...
      function levelset_falling_drop(xyz,t) result(G)
         ...
         real(WP) :: G
         ! Create the droplet
         G = Pi-xyz(2)+A0*cos(twoPi*xyz(1)/lambda)
