...
meshsize="8";
filename=folderpick+"/Run_CASE1_nx"+meshsize+"/monitor/simulation";
...
% hold on
% plot(time_128,(Asim_128-pi)/(2*pi),'LineWidth',LW2,'LineStyle','-')
hold on
...
% hold on
% plot(time_128,error_128,'LineWidth',LW2,'LineStyle','-')
xlim([0,20])
ylim([-0.45,0.45])
...
% dx=[2*pi/8 2*pi/16 2*pi/32 2*pi/64 2*pi/128];
% rms_list=[rms_8 rms_16 rms_32 rms_64 rms_128];
