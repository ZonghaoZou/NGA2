 ...
 contains
    ...
    subroutine init(this,group)
       ...
       initialize_config: block
          ...
          ! Read in grid definition (same mesh as the main simulation)
          ...
          ! Read in partition (same partition as the main simulation)
       ...
       initialize_velocity: block
          ...
          allocate(seed(nseed))
          seed = 12345       ! Fixed seed value (can be any integer)
