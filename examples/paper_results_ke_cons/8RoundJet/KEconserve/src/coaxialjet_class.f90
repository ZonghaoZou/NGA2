...
module coaxialjet_class
   ...
   type :: coaxialjet
      ...
      real(WP), dimension(:,:,:), allocatable :: resUmid,resVmid,resWmid,resVF
      real(WP), dimension(:,:,:), allocatable :: Ui,Vi,Wi            !< Cell-centered velocities
      
      !> Iterator for VOF removal
      type(iterator) :: vof_removal_layer  !< Edge of domain where we actively remove VOF
      real(WP) :: vof_removed              !< Integral of VOF removed
      integer  :: nlayer=20                 !< Size of buffer layer for VOF removal
      ...
      real(WP) :: resVFmax,resUmidmax,resVmidmax,resWmidmax
      real(WP) :: resVFbase,resUmidbase,resVmidbase,resWmidbase
   contains
...
contains
   ...
   subroutine init(this)
      ...
      allocate_work_arrays: block
         ...
         allocate(this%resVF        (this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_))
         allocate(this%resUmid      (this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_))
         allocate(this%resVmid      (this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_))
         allocate(this%resWmid      (this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_))
         allocate(this%Ui           (this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_))
         allocate(this%Vi           (this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_))
         allocate(this%Wi           (this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_))
         this%resVFmax=0.0_WP;this%resUmidmax=0.0_WP;this%resVmidmax=0.0_WP;this%resWmidmax=0.0_WP
      ...
      initialize_velocity: block
         ...
         call param_read('Noise amp',this%namp,default=0.1_WP);this%namp=this%namp*this%Ug
         ...
         do n=1,mybc%itr%no_
            ...
            ! Set gas profile
            if (r.ge.0.5_WP*this%Dl+this%lip.and.r.le.0.5_WP*this%Dl+this%lip+this%Hg) then
               this%fs%U(i,j,k)=this%Ug*erf((r-(0.5_WP*this%Dl+this%lip))/this%delta_g)*erf(((0.5_WP*this%Dl+this%lip+this%Hg)-r)/this%delta_g)+random_uniform(lo=-0.5_WP*this%namp,hi=+0.5_WP*this%namp)
            end if 
         end do
      ...
      ! Create surfmesh object for interface polygon output with a curvature outputed
      create_smesh: block
         ...
         this%smesh%varname(1)='curvature'
         call this%vf%update_surfmesh(this%smesh)
         np=0
         do k=this%cfg%kmin_,this%cfg%kmax_
            do j=this%cfg%jmin_,this%cfg%jmax_
               do i=this%cfg%imin_,this%cfg%imax_
                  if (this%vf%VF(i,j,k).lt.2.0_WP*epsilon(1.0_WP)) cycle ! Skip cells below VF threshold
      ...
      create_monitor: block
         ...
         call this%mfile%add_column(this%fs%Umidmax,'Umidmax')
         call this%mfile%add_column(this%fs%Vmidmax,'Vmidmax')
         call this%mfile%add_column(this%fs%Wmidmax,'Wmidmax')
         call this%mfile%add_column(this%resUmidmax,'resUmidmax')
         call this%mfile%add_column(this%resVmidmax,'resVmidmax')
         call this%mfile%add_column(this%resWmidmax,'resWmidmax')
         call this%mfile%add_column(this%resVFmax,'resVFmax')
   ...
   subroutine step(this)
      ...
      end block set_noise_inflow

      ! Perform sub-iterations
      do while (this%time%it.le.this%time%itmax)
            
         ! Store past iteration info to check final convergence
         ! this%resU=this%vf%VF
         ! this%resUmid=this%fs%Umid
         ! this%resVmid=this%fs%Vmid
         ! this%resWmid=this%fs%Wmid
         ! VOF equation ====================================================
         ...
         !    integer :: i,j,k,ierr
         !    if (this%time%it.eq.1) then
         !       this%resVFbase=0.0_WP;this%resUmidbase=0.0_WP;this%resVmidbase=0.0_WP;this%resWmidbase=0.0_WP
         !       do k=this%cfg%kmin_,this%cfg%kmax_
         !          do j=this%cfg%jmin_,this%cfg%jmax_
         !            do i=this%cfg%imin_,this%cfg%imax_
         !                ! Get the first step maximum residual as a base measure
         !                this%resVFbase  =max(this%resVFbase  ,abs(this%resVF(i,j,k)-this%vf%VF(i,j,k)))
         !                this%resUmidbase=max(this%resUmidbase,abs(this%resUmid(i,j,k)-this%fs%Umid(i,j,k)))
         !                this%resVmidbase=max(this%resVmidbase,abs(this%resVmid(i,j,k)-this%fs%Vmid(i,j,k)))
         !                this%resWmidbase=max(this%resWmidbase,abs(this%resWmid(i,j,k)-this%fs%Wmid(i,j,k)))
         !            end do 
         !          end do
         !       end do
         !       call MPI_ALLREDUCE(MPI_IN_PLACE,this%resVFbase,1,MPI_REAL_WP,MPI_MAX,this%cfg%comm,ierr)
         !       call MPI_ALLREDUCE(MPI_IN_PLACE,this%resUmidbase,1,MPI_REAL_WP,MPI_MAX,this%cfg%comm,ierr)
         !       call MPI_ALLREDUCE(MPI_IN_PLACE,this%resVmidbase,1,MPI_REAL_WP,MPI_MAX,this%cfg%comm,ierr)
         !       call MPI_ALLREDUCE(MPI_IN_PLACE,this%resWmidbase,1,MPI_REAL_WP,MPI_MAX,this%cfg%comm,ierr)
         !    else
         !       this%resVFmax=0.0_WP;this%resUmidmax=0.0_WP;this%resVmidmax=0.0_WP;this%resWmidmax=0.0_WP
         !       do k=this%cfg%kmin_,this%cfg%kmax_
         !          do j=this%cfg%jmin_,this%cfg%jmax_
         !            do i=this%cfg%imin_,this%cfg%imax_
         !                this%resVFmax  =max(this%resVFmax  ,abs(this%resVF(i,j,k)-this%vf%VF(i,j,k)))
         !                this%resUmidmax=max(this%resUmidmax,abs(this%resUmid(i,j,k)-this%fs%Umid(i,j,k)))
         !                this%resVmidmax=max(this%resVmidmax,abs(this%resVmid(i,j,k)-this%fs%Vmid(i,j,k)))
         !                this%resWmidmax=max(this%resWmidmax,abs(this%resWmid(i,j,k)-this%fs%Wmid(i,j,k)))
         !            end do 
         !          end do
         !       end do
         !       call MPI_ALLREDUCE(MPI_IN_PLACE,this%resVFmax,1,MPI_REAL_WP,MPI_MAX,this%cfg%comm,ierr)
         !       call MPI_ALLREDUCE(MPI_IN_PLACE,this%resUmidmax,1,MPI_REAL_WP,MPI_MAX,this%cfg%comm,ierr)
         !       call MPI_ALLREDUCE(MPI_IN_PLACE,this%resVmidmax,1,MPI_REAL_WP,MPI_MAX,this%cfg%comm,ierr)
         !       call MPI_ALLREDUCE(MPI_IN_PLACE,this%resWmidmax,1,MPI_REAL_WP,MPI_MAX,this%cfg%comm,ierr)
         !       if(this%time%it.eq.this%time%itmax) then
         !          this%resVFmax = this%resVFmax/this%resVFbase
         !          this%resUmidmax = this%resUmidmax/this%resUmidbase
         !          this%resVmidmax = this%resVmidmax/this%resVmidbase
         !          this%resWmidmax = this%resWmidmax/this%resWmidbase
         !       end if
         !    end if
         ! end block checkResidual
