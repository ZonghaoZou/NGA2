clear
format longG
string="results/LA1p2e2";
ca_8_e2= readmatrix(string+"/8.csv", 'Delimiter', ',');
ca_16_e2= readmatrix(string+"/16.csv", 'Delimiter', ',');
ca_32_e2= readmatrix(string+"/32.csv", 'Delimiter', ',');
ca_64_e2= readmatrix(string+"/64.csv", 'Delimiter', ',');

string="results/LA1p2e4";
ca_8_e4= readmatrix(string+"/8.csv", 'Delimiter', ',');
ca_16_e4= readmatrix(string+"/16.csv", 'Delimiter', ',');
ca_32_e4= readmatrix(string+"/32.csv", 'Delimiter', ',');
ca_64_e4= readmatrix(string+"/64.csv", 'Delimiter', ',');

string="results/LA1p2e6";
ca_8_e6= readmatrix(string+"/8.csv", 'Delimiter', ',');
ca_16_e6= readmatrix(string+"/16.csv", 'Delimiter', ',');
ca_32_e6= readmatrix(string+"/32.csv", 'Delimiter', ',');
ca_64_e6= readmatrix(string+"/64.csv", 'Delimiter', ',');
...
cmax_8=max(ca_8_e2);
cmax_16=max(ca_16_e2);
cmax_32=max(ca_32_e2);
cmax_64=max(ca_64_e2);
ca_rms_U_e2=[cmax_8(1) cmax_16(1) cmax_32(1) cmax_64(1)];
ca_max_U_e2=[cmax_8(2) cmax_16(3) cmax_32(3) cmax_64(3)];
% ca_rms_U_e2=[cmax_8(2) cmax_16(2) cmax_32(2) cmax_64(2)];
% ca_max_U_e2=[cmax_8(4) cmax_16(4) cmax_32(4) cmax_64(4)];

cmax_8=max(ca_8_e4);
cmax_16=max(ca_16_e4);
cmax_32=max(ca_32_e4);
cmax_64=max(ca_64_e4);
ca_rms_U_e4=[cmax_8(1) cmax_16(1) cmax_32(1) cmax_64(1)];
ca_max_U_e4=[cmax_8(3) cmax_16(3) cmax_32(3) cmax_64(3)];

% ca_rms_U_e4=[cmax_8(2) cmax_16(2) cmax_32(2) cmax_64(2)];
% ca_max_U_e4=[cmax_8(4) cmax_16(4) cmax_32(4) cmax_64(4)];

cmax_8=max(ca_8_e6);
cmax_16=max(ca_16_e6);
cmax_32=max(ca_32_e6);
cmax_64=max(ca_64_e6);
ca_rms_U_e6=[cmax_8(1) cmax_16(1) cmax_32(1) cmax_64(1)];
ca_max_U_e6=[cmax_8(3) cmax_16(3) cmax_32(3) cmax_64(3)];

% ca_rms_U_e6=[cmax_8(2) cmax_16(2) cmax_32(2) cmax_64(2)];
% ca_max_U_e6=[cmax_8(4) cmax_16(4) cmax_32(4) cmax_64(4)];
